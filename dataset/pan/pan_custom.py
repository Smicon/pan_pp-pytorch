...
ctw_root_dir = '/data/zhangyl/data/'

# ctw_train_data_dir = ctw_root_dir + '5.0_3000/'
# ctw_train_gt_dir = ctw_root_dir + '5.0_3000/'
ctw_train_data_dir = ctw_root_dir + '4.0/'
ctw_train_gt_dir = ctw_root_dir + '4.0/'
