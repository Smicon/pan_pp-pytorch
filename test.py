...
def test(test_loader, model, cfg):
    ...
    os.makedirs(cfg.test_cfg.result_path, exist_ok=True)
...
def main(args):
    ...
    # fuse conv and bn
    model = fuse_module(model)  # fixme: 看不懂
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', help='config file path', default=r"./config/pan_pp/pan_pp_r18_ctw.py")
    parser.add_argument('--checkpoint', nargs='?', type=str, default=r"./checkpoints/test12/checkpoint.pth.tar")
